    ...
    >
      ...
      <div className="relative shadow-sm">
        <input
          ...
          className="w-full pl-10 pr-20 py-2 h-10 rounded-lg border border-gray-100 
                   placeholder-gray-400 focus:outline-none focus:border-pink-200 
                   focus:ring-1 focus:ring-pink-100 transition-all duration-200
                   text-sm shadow-sm"
        ...
        <button
          ...
          className="absolute right-2 top-1/2 transform -translate-y-1/2 
                   px-4 py-1 bg-pink-500 text-white text-sm rounded-md
                   hover:bg-pink-600 transition-all duration-200 h-8
